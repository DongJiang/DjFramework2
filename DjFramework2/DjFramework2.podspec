#
#  Be sure to run `pod spec lint DjFramework2.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Jiang Dong" => "jiang.dong@vim.ai" }
  # Or just: spec.author    = "Jiang Dong"
  # spec.authors            = { "Jiang Dong" => "jiang.dong@vim.ai" }
  # spec.social_media_url   = "https://twitter.com/Jiang Dong"
